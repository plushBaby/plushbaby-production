  ...
  return (
    ...
    >
      ...
      <TextField
        ...
        onChange={(event) =>
          setListingData({ ...listingData, subtitle: event.target.value })
        }
      />
      <TextField
        name="price"
        ...
        onChange={(event) =>
          setListingData({ ...listingData, price: event.target.value })
        }
      />
      <TextField
        name="condition"
      ...
      <FormControl fullWidth variant="outlined" className={classes.formControl}>
        ...
        <Select
          ...
          fullWidth
          onChange={(event) =>
            setListingData({ ...listingData, category: event.target.value })
          }
        >
      ...
      >
        {" "}
        {loadedListing ? "Update changes" : "Publish"}{" "}
      </Button>
    </form>
  );
};
